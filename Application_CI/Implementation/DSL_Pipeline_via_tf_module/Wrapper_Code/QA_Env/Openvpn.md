# DSL Jenkins pipeline for Openvpn setup in QA Env 
...
pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'shreya/openvpn-wrapper-code-qa', credentialsId: 'shreya PAT', url: 'https://github.com/CodeOps-Hub/Terraform-modules.git'
            }
        }
        ...
        stage('Copy Terraform Files') {
            steps {
                ...
                sh 'cp wrapperCode/Openvpn-wrapper-code/QA-Env/* .'
            }
        }
