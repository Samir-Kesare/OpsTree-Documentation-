...
<br>
  ...
  ```shell
Started by user shreya
Obtained Jenkinsfile from git https://github.com/CodeOps-Hub/Jenkinsfile.git
[Pipeline] Start of Pipeline
[Pipeline] node
Running on Jenkins in /var/lib/jenkins/workspace/Attendance_pipeline
[Pipeline] {
[Pipeline] stage
...
using credential GitHub Credentials for DSL PIpleline
Cloning the remote Git repository
Cloning repository https://github.com/CodeOps-Hub/Jenkinsfile.git
 > git init /var/lib/jenkins/workspace/Attendance_pipeline # timeout=10
...
Avoid second fetch
 > git rev-parse refs/remotes/origin/khushi/Attendance_pipeline^{commit} # timeout=10
Checking out Revision 075cda617ebf6fe4795ae083b6772c4f90f9163c (refs/remotes/origin/khushi/Attendance_pipeline)
 > git config core.sparsecheckout # timeout=10
 > git checkout -f 075cda617ebf6fe4795ae083b6772c4f90f9163c # timeout=10
Commit message: "Update Jenkinsfile"
 > git rev-list --no-walk 075cda617ebf6fe4795ae083b6772c4f90f9163c # timeout=10
[Pipeline] }
[Pipeline] // stage
[Pipeline] withEnv
[Pipeline] {
...
The recommended git tool is: NONE
using credential GitHub Credentials for DSL PIpleline
 > git rev-parse --resolve-git-dir /var/lib/jenkins/workspace/Attendance_pipeline/.git # timeout=10
...
Checking out Revision e306f93dda9edd7cd81a86ceb9e74badf0c604e6 (refs/remotes/origin/main)
 > git config core.sparsecheckout # timeout=10
 > git checkout -f e306f93dda9edd7cd81a86ceb9e74badf0c604e6 # timeout=10
 > git branch -a -v --no-abbrev # timeout=10
 > git checkout -b main e306f93dda9edd7cd81a86ceb9e74badf0c604e6 # timeout=10
Commit message: "Update variable.tf"
 > git rev-list --no-walk e306f93dda9edd7cd81a86ceb9e74badf0c604e6 # timeout=10
[Pipeline] }
[Pipeline] // stage
[Pipeline] stage
[Pipeline] { (Copy Terraform Files)
[Pipeline] sh
+ cp Dev_Infra/Static_Tf/Attendance/main.tf Dev_Infra/Static_Tf/Attendance/output.tf Dev_Infra/Static_Tf/Attendance/provider.tf Dev_Infra/Static_Tf/Attendance/script.sh Dev_Infra/Static_Tf/Attendance/variable.tf .
[Pipeline] }
[Pipeline] // stage
[Pipeline] stage
...
[0m  [32m+[0m[0m resource "aws_ami_from_instance" "AMI" {
      ...
      [32m+[0m[0m name                 = "Dev-Attendance-AMI"
      ...
      [32m+[0m[0m source_instance_id   = "i-019f7170b97a143c7"
...
[1m  # aws_autoscaling_group.attendance_asg[0m will be created
[0m  [32m+[0m[0m resource "aws_autoscaling_group" "attendance_asg" {
      [32m+[0m[0m arn                              = (known after apply)
      ...
      [32m+[0m[0m name                             = "Dev_Attendance_ASG"
      ...
      [32m+[0m[0m vpc_zone_identifier              = [
          [32m+[0m[0m "subnet-0a712151efeb16f4f",
        ]
      ...
      [32m+[0m[0m tag {
          ...
          [32m+[0m[0m value               = "Dev_Attendance_ASG"
        }
    }

[1m  # aws_autoscaling_policy.attendance_ASG_Policy[0m will be created
[0m  [32m+[0m[0m resource "aws_autoscaling_policy" "attendance_ASG_Policy" {
      [32m+[0m[0m arn                     = (known after apply)
      [32m+[0m[0m autoscaling_group_name  = "Dev_Attendance_ASG"
...
[0m  [32m+[0m[0m resource "aws_key_pair" "key_pair" {
      ...
      [32m+[0m[0m id              = (known after apply)
      [32m+[0m[0m key_name        = "Dev_Key_attendence"
...
[1m  # aws_launch_template.Attendance_Launch_Template[0m will be created
[0m  [32m+[0m[0m resource "aws_launch_template" "Attendance_Launch_Template" {
      [32m+[0m[0m arn             = (known after apply)
      [32m+[0m[0m default_version = (known after apply)
      [32m+[0m[0m description     = "Launch template for attendance api"
      [32m+[0m[0m id              = (known after apply)
      [32m+[0m[0m image_id        = (known after apply)
      [32m+[0m[0m instance_type   = "t2.micro"
      [32m+[0m[0m key_name        = "Dev_Key_attendence"
      [32m+[0m[0m latest_version  = (known after apply)
      [32m+[0m[0m name            = "AttendanceAPI-Launch-Template"
      [32m+[0m[0m name_prefix     = (known after apply)
      [32m+[0m[0m tags            = {
          [32m+[0m[0m "Name" = "AttendanceAPI-Launch-Template"
        }
      ...
      [32m+[0m[0m user_data       = "IyEvYmluL2Jhc2gKY2QgYXR0ZW5kYW5jZQpjZCBhdHRlbmRhbmNlLWFwaS8KcG9ldHJ5IHNoZWxsCmd1bmljb3JuIGFwcDphcHAgLS1sb2ctY29uZmlnIGxvZy5jb25mIC1iIDAuMC4wLjA6ODA4MAo="

      [32m+[0m[0m network_interfaces {
          [32m+[0m[0m security_groups = (known after apply)
          [32m+[0m[0m subnet_id       = "subnet-0a712151efeb16f4f"
        }
    }
...
[0m  [32m+[0m[0m resource "aws_lb_target_group" "Target_group" {
      ...
      [32m+[0m[0m name                               = "Dev-Attendance-TG"
      [32m+[0m[0m name_prefix                        = (known after apply)
      [32m+[0m[0m port                               = 8080
      ...
      [32m+[0m[0m vpc_id                             = "vpc-0d744158f7f47f419"
      ...
      [32m+[0m[0m health_check {
          ...
          [32m+[0m[0m path                = "/api/v1/attendance/health"
...
[1m  # aws_security_group.attendance_sg[0m will be created
[0m  [32m+[0m[0m resource "aws_security_group" "attendance_sg" {
      [32m+[0m[0m arn                    = (known after apply)
      [32m+[0m[0m description            = "Security group for Attendance-API"
      [32m+[0m[0m egress                 = [
          [32m+[0m[0m {
      ...
      [32m+[0m[0m ingress                = [
          ...
          [32m+[0m[0m {
              ...
              [32m+[0m[0m protocol         = "tcp"
              [32m+[0m[0m security_groups  = [
                  [32m+[0m[0m "sg-0add0279237c66ee0",
                ]
              [32m+[0m[0m self             = false
              [32m+[0m[0m to_port          = 22
            },
...
[0m  [32m+[0m[0m resource "local_file" "private_key" {
      ...
      [32m+[0m[0m filename             = "Dev_Key_attendence.pem"
      [32m+[0m[0m id                   = (known after apply)
    }
...
[0m[1maws_security_group.attendance_sg: Creating...[0m[0m
[0m[1maws_lb_target_group.Target_group: Creation complete after 1s [id=arn:aws:elasticloadbalancing:us-east-1:905418193488:targetgroup/Dev-Attendance-TG/63ce0cada5daef3a][0m
[0m[1maws_lb_listener_rule.path_rule: Creating...[0m[0m
[0m[1maws_lb_listener_rule.path_rule: Creation complete after 1s [id=arn:aws:elasticloadbalancing:us-east-1:905418193488:listener-rule/app/alb-heh/127dfdd55a957475/99ac24ae778e4e38/159eb6ac37fad02f][0m
[0m[1mtls_private_key.private_key: Creation complete after 3s [id=52bb2a861bd8f16c4a2d298b0849f4468dba9503][0m
[0m[1maws_key_pair.key_pair: Creating...[0m[0m
[0m[1mlocal_file.private_key: Creating...[0m[0m
[0m[1mlocal_file.private_key: Creation complete after 0s [id=76165b51a99b40b70bc8a5e1896b598991d2c140][0m
[0m[1maws_security_group.attendance_sg: Creation complete after 3s [id=sg-065fc97060e5750b0][0m
[0m[1maws_key_pair.key_pair: Creation complete after 0s [id=Dev_Key_attendence][0m
...
[0m[1maws_ami_from_instance.AMI: Creation complete after 3m7s [id=ami-07e890847f88d82cd][0m
[0m[1maws_launch_template.Attendance_Launch_Template: Creating...[0m[0m
[0m[1maws_launch_template.Attendance_Launch_Template: Creation complete after 0s [id=lt-0ffc17c33548d472e][0m
[0m[1maws_autoscaling_group.attendance_asg: Creating...[0m[0m
[0m[1maws_autoscaling_group.attendance_asg: Still creating... [10s elapsed][0m[0m
[0m[1maws_autoscaling_group.attendance_asg: Still creating... [20s elapsed][0m[0m
[0m[1maws_autoscaling_group.attendance_asg: Still creating... [30s elapsed][0m[0m
[0m[1maws_autoscaling_group.attendance_asg: Still creating... [40s elapsed][0m[0m
[0m[1maws_autoscaling_group.attendance_asg: Creation complete after 41s [id=Dev_Attendance_ASG][0m
[0m[1maws_autoscaling_policy.attendance_ASG_Policy: Creating...[0m[0m
[0m[1maws_autoscaling_policy.attendance_ASG_Policy: Creation complete after 0s [id=target-tracking-policy][0m
[0m[1m[32m
...
[0mAMI_ID = [
  "ami-07e890847f88d82cd",
]
Target_group_id = [
  "arn:aws:elasticloadbalancing:us-east-1:905418193488:targetgroup/Dev-Attendance-TG/63ce0cada5daef3a",
]
key_pair_name = [
  "Dev_Key_attendence",
]
launch_template_id = "lt-0ffc17c33548d472e"
security_group_id = "sg-065fc97060e5750b0"
target_group_arn = [
  "arn:aws:elasticloadbalancing:us-east-1:905418193488:targetgroup/Dev-Attendance-TG/63ce0cada5daef3a",
]
[Pipeline] }
