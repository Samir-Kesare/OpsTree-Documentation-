...
| 110         | Custom TCP      | TCP      | 1024-65535         | 10.1.0.16/28    | Allow      |
...
| 110         | Custom TCP| TCP      | 3000       | 10.1.0.0/28  | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
| 130         | Custom TCP| TCP      | 32768-65535| 10.1.0.0/28  | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
|-------------|-----------|----------|------------|--------------|------------|
| 100         | SSH       | TCP      | 22         | 20.0.0.0/28  | Allow      |
| 110         | Custom TCP| TCP      | 8080       | 10.1.0.0/28 | Allow      |
| 120         | Custom TCP      | TCP      | 1024-65535         | 10.1.0.48/28    | Allow      |
| 130         | Custom TCP      | TCP      | 1024-65535         | 10.1.0.64/28    | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
| 110         | Custom TCP| TCP      | 8080       | 10.1.0.0/28 | Allow      |
| 120         | Custom TCP| TCP      | 1024-65535 | 20.0.0.0/28  | Allow      |
| 130         | Custom TCP| TCP      | 1024-65535| 10.1.0.48/28 | Allow      |
| 140         | Custom TCP| TCP      | 1024-65535| 10.1.0.64/28 | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
|-------------|-----------|----------|------------|--------------|------------|
| 100         | SSH       | TCP      | 22         | 20.0.0.0/28  | Allow      |
| 110         | Custom TCP(Redis)| TCP      | 6379       | 10.1.0.32/28 | Allow      |
| 120         | Custom TCP(Scylla)| TCP      | 9042       | 10.1.0.32/28 | Allow      |
| 130         | Custom TCP (PostgreSQL) | TCP| 5432    | 10.1.0.32/28 | Allow      |
| *           | All traffic | All     | All        | 0.0.0.0/0    | Deny       |
...
| 120         | Custom TCP(Scylla)| TCP      | 9042       | 10.1.0.32/28 | Allow      |
| 130         | Custom TCP (PostgreSQL) | TCP| 5432    | 10.1.0.32/28 | Allow      |
| 140         | Custom TCP| TCP      | 1024-65535 | 10.1.0.32/28 | Allow      |
